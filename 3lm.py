...
print("SUCCES LOGIN TO ✍͡➴͜ოυȿἶβąƮ")
print("line://app/1602687308-GXq4Vvk9?type=text&text=line.me/ti/p/~musibat83")
...
tagadd = {
    ...
    "add": "Thanks for ading me..😊😊",
    "wctext": "Welcome..☺☺",
    "lv": "Bye bye Dear, Miss you..😢😢😢",
    "b": "Autoband😝😝😝",
    "c":"Auto Like By. ✍͡➴͜ოυȿἶβąƮ",
    "m": " >_<",
}
apalo = {
    "winvite": False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "umumkan":
                    ...
                    sa+="\nContoh"
                    sa+="\n- Pengumuman/Id line"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " ✍͡➴͜ოυȿἶβąƮ", "iconUrl": "https://obs.line-scdn.net/{}".format(ghi.getContact(ghiMID).pictureStatus),"linkUrl": "line.me/ti/p/~musibat83"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "Putih":
                  if msg._from in admin:
                      ...
                      try:
                          tagadd["tag"] = text_
                          sa = "「 Settag 」\nApakah : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "✍͡➴͜ოυȿἶβąƮ ", "iconUrl": "https://obs.line-scdn.net/{}".format(ghi.getContact(ghiMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ubd86e8c77559b1493f0ad64b1dba2d6c"}}
                          sendTemplate(to,data)
                      except:
...
#=====================================================================
                            ...
                            try:
                                ...
                                ghi.updateProfileCoverById(coverId)
                                BackupProfile = ghi.getContact(sender)
                                sendMention(to, BackupProfile.mid, "=͟͟͞͞➳ Succes Previous Profile", ">_<");ghi.sendContact(to, str(BackupProfile.mid))
                            except Exception as error:
...
#=====================================================================
                ...
                elif text.lower() == 'speed':start = time.time();ghi.sendMessage("ubd86e8c77559b1493f0ad64b1dba2d6c", "✍͡➴͜ოυȿἶβąƮ");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                    ...
                    gid = ghi.getGroup(to)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    ghi.sendMessage(to, ghi.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+ghi.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "✍͡➴͜ოυȿἶβąƮ", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '✍͡➴͜ოυȿἶβąƮ', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
