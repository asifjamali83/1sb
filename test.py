...
sets = {
    "l":True,
      "c":True,
      "cm":"Auto Like By.✡Mus!༼BÁT✡\nline.me/ti/p/~musibat83",
    "winvite": False,
    "wblacklist": False,
    "tagsticker": False,
    "Sticker": False,
...
tagadd = {
    "tagss": False,
    "tags": False,
    "tag": "Im Busy Right Now.. \n How can i Help You....🤣🤣🤣",
    "add": "Thanks For Add me..😊😊",
    "wctext": "Welcome to Sucide Squad..☺☺",
    "lv": "Bye Bye / Miss you..😢😢😢",
    "b": "Self Bot By. 🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰 Sistem's😝😝😝",
    "c":"Auto Like By. 🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰",
    "m": " >_<",
}
apalo = {
    "winvite": False,
...
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/~musibat83"
...
def mentions(to, text="", mids=[]):
    ...
    ghi.sendMessage(to, textx, {'AGENT_NAME':'LINE OFFICIAL', 'AGENT_LINK': 'line://ti/p/~{}'.format(ghi.getProfile().userid), 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + ghi.getContact("ubcd98265d4210c2215f3ddb43d79c414").picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
                     ...
                     if msg._from in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ghi.sendMessage(msg.to,"-> " + _name + " Successfully invited")
                                 break
                             elif invite in apalo["blacklist"]:
                                 ghi.sendMessage(msg.to,"Sorry " + _name + " This person is blacklisted")
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     ghi.sendMessage(msg.to,"invite :" + _name + "Complete")
                                     apalo["winvite"] = False
                                     break
                                 except:
                                     try:
                                         ...
                                         ghi.sendMessage(msg.to,"Detect unknown errors😩 Maybe your account has been blocked")
                                         apalo["winvite"] = False
                                         break
        if op.type == 25:
            msg = op.message
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "umumkan":
                    ...
                    sa+="\nContoh"
                    sa+="\n- Pengumuman/Id line"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " 🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰", "iconUrl": "https://obs.line-scdn.net/{}".format(ghi.getContact(ghiMID).pictureStatus),"linkUrl": "line.me/ti/p/~musibat83"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "Putih":
                  if msg._from in admin:
                      ...
                      duc1(to, "Kirim targetnya")
                elif msg.text.lower().startswith("setrespon "):
                      text_ = removeCmd("setrespon", text)
                      try:
                          tagadd["tag"] = text_
                          sa = "「 setrespon 」\nSet : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰 ", "iconUrl": "https://obs.line-scdn.net/{}".format(ghi.getContact(ghiMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ubd86e8c77559b1493f0ad64b1dba2d6c"}}
                          sendTemplate(to,data)
                      except:
...
#=====================================================================
                ...
                if text.lower() == "mid" or text.lower() == "mymid":
                    ...
                    ghi.sendReplyMessage(msg.id, to,ghiMID)
                        ...
                        apalo["winvite"] = True
                        duc1(to, "Send the contact to invite")
...
"type": "uri",
"label": "Contact us",
"uri": "https://line.me/ti/p/~musibat83",
}
},
{
"flex": 3,
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "contents": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/~musibat83"
                                                        }
                                                    },
                                                    {
                                                        "type": "spacer",
                ...
                if text.lower() == "runtime2" or text.lower() == "runtime2":
                    ...
                    data = {
                        ...
                        "sentBy": {
                             ...
                             "linkUrl": "line.me/ti/p/~musibat83"
                        }
                    }
                    sendTemplate(to, data)
...
#=====================================================================
                ...
                elif text.lower() == 'speed':start = time.time();ghi.sendMessage("ubd86e8c77559b1493f0ad64b1dba2d6c", "🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                    ...
                    gid = ghi.getGroup(to)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    ghi.sendMessage(to, ghi.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+ghi.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '🔰✯ͥ ͣ ͫ͢Mus!༼BÁT༻🔰', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if msg.text.lower() == "jalankan api":
                    ...
                    data = {"type": "text","text": "{}".format(lisk),"sentBy": {"label": "list API", "iconUrl": "https://obs.line-scdn.net/{}".format(ghi.getContact(ghiMID).pictureStatus),"linkUrl": "line://ti/p/~musibat83"}}
                    sendTemplate(to,data)
#==============================================================================#
#==============================================================================#
        if op.type == 25:
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#opration.type 55 is difine siders...
        if op.type == 55:
            try:
                if op.param1 in settings["RAreadPoint"]:
                   if op.param2 in settings["RAreadMember"][op.param1]:
                       pass
                   else:
                       settings["RAreadMember"][op.param1][op.param2] = True
                else:
                   pass
            except:
                pass
        ...
        if op.type == 55:
            if op.param2 in wait["blacklist"]:
                ghi.kickoutFromGroup(op.param1,[op.param2])
            else:
                pass
        ...
        if op.type == 55:
            if cctv['cyduk'][op.param1]==True:
                if op.param1 in cctv['point']:
                    Name = ghi.getContact(op.param2).displayName
  ...
  "hero": {
    ...
    "aspectRatio": "20:13",
    "aspectMode": "cover",
    "url": "https://obs.line-scdn.net/{}".format(ghi.getContact(op.param2).pictureStatus),
    "size": "full",
    "margin": "xxl"
  },
  "footer": {
  ...
  "header": {
    ...
    "contents": [
      {
        "type": "text",
        "text": "{}".format(ghi.getContact(op.param2).displayName),
        "size": "md",
        "wrap": True,
        "weight": "bold",
        "color": "#F0F8FF",
        "align": "center"
                        ...
                        ghi.postTemplate(op.param1, data);
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  sendTemplate(msg.to, "°❂°sider deactivated\n\n°❂°Date : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n°❂°hour [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
                                  sendTemplate(msg.to, "°❂°It is no longer active")
